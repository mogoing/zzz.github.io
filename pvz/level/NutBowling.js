oS.Init({
    ...
    ZName: [oZombie, oZombie2, oZombie3, oConeheadZombie, oNewspaperZombie, oBucketheadZombie, oPoleVaultingZombie],
        ...
        PrepareGrowPlants(function() {
            oP.Monitor({
                f: function() { (function() {
                        var a = ArCard.length;
                        if (a < 10) {
                            var c = [oNutBowling, oNutBowling, oNutBowling, oNutBowling, oBoomNutBowling],
...
{
    AZ: [[oZombie, 4, 1], [oZombie2, 2, 1], [oZombie3, 2, 1], [oConeheadZombie, 4, 1], [oBucketheadZombie, 4, 1], [oNewspaperZombie, 2, 1], [oPoleVaultingZombie, 2, 10]],
    FlagNum: 20,
    FlagToSumNum: {
