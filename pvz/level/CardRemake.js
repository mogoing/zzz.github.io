oS.Init({
	NextCard: {oPeashooter:oSunFlower,oSunFlower:oCherryBomb,oCherryBomb:oWallNut,oWallNut:oPotatoMine,oPotatoMine:oSnowPea,oSnowPea:oChomper,oChomper:oRepeater,oRepeater:oPuffShroom,oPuffShroom:oSunShroom,oSunShroom:oFumeShroom,oFumeShroom:oHypnoShroom,oHypnoShroom:oScaredyShroom,oScaredyShroom:oIceShroom,oIceShroom:oDoomShroom,oDoomShroom:oLilyPad,oLilyPad:oSquash,oSquash:oThreepeater,oThreepeater:oTangleKelp,oTangleKelp:oJalapeno,oJalapeno:oSpikeweed,oSpikeweed:oTorchwood,oTorchwood:oTallNut,oTallNut:oSeaShroom,oSeaShroom:oPlantern,oPlantern:oCactus,oCactus:oSplitPea,oSplitPea:oStarfruit,oStarfruit:oPumpkinHead,oPumpkinHead:oFlowerPot,oFlowerPot:oCoffeeBean,oCoffeeBean:oGarlic,oGarlic:oPeashooter,oGatlingPea:oGloomShroom,oGloomShroom:oTwinSunflower,oTwinSunflower:oSpikerock,oSpikerock:oGatlingPea},
	PName: [oPeashooter, oSunFlower, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater, oPuffShroom, oSunShroom, oFumeShroom, oHypnoShroom, oScaredyShroom, oIceShroom, oDoomShroom, oLilyPad, oSquash, oThreepeater, oTangleKelp, oJalapeno, oSpikeweed, oTorchwood, oTallNut, oSeaShroom, oPlantern, oCactus, oSplitPea, oStarfruit, oPumpkinHead, oFlowerPot, oCoffeeBean, oGarlic, oGatlingPea, oGloomShroom, oTwinSunflower, oSpikerock],
	...
	FlagNum: 40,
	FlagToSumNum: {
		a1: [   3, 5,  9, 10, 13, 15, 17, 19, 20, 23, 25, 29, 30, 32, 35, 37, 38, 39],
		a2: [1, 3, 5, 12,  7, 12, 14, 16, 30, 16, 18, 22, 38, 23, 27, 30, 33, 34, 59]
	},
	FlagToMonitor: {
		9: [ShowLargeWave, 0],
		19: [ShowLargeWave, 0],
